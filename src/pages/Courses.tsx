...
const courses = [
  { id: "web-dev", icon: Code, title: "Full-Stack Web Development", desc: "Master React, Node.js, databases, and deployment. Build production-ready apps from scratch.", duration: "12 Weeks", students: "2,400+", rating: "4.5", level: "Beginner to Advanced", price: "GH₵ 1,500", internship: true },
  ...
  { id: "ai-ml", icon: Brain, title: "AI & Machine Learning", desc: "Python, TensorFlow, neural networks, NLP, and real-world AI project deployment.", duration: "16 Weeks", students: "1,600+", rating: "4.9", level: "Intermediate to Advanced", price: "GH₵1,750", internship: true },
  { id: "it-support", icon: Monitor, title: "IT Support & Administration", desc: "CompTIA A+ prep, networking, troubleshooting, and enterprise system administration.", duration: "8 Weeks", students: "3,100+", rating: "4.8", level: "Beginner", price: "GH₵1,490", internship: false },
